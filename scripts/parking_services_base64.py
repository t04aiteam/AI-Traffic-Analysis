...
from images encoded as base64 strings.
...
def decode_image_base64(image_base64: str) -> np.ndarray:
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="Invalid base64 image string") from exc
...
async def read_plate(
    ...
    det_conf = request.conf_threshold
    ocr_conf = request.ocr_threshold
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        "scripts.parking_services_base64:app",
